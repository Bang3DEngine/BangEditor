...
MenuItem::MenuItem(MenuItemType itemType)
{
    ...
    else
    {
            ...
            GetItemType() == MenuItemType::NORMAL)
        {
            ...
            if (GetItemType() != MenuItemType::TOP)
            {
                ...
                UILayoutElement *rightArrowLE =
                    p_rightArrow->GetGameObject()
    ...
    UIContentSizeFitter *csf =
        childrenListGo->AddComponent<UIContentSizeFitter>();
...
bool MenuItem::IsSelected() const
{
    switch (GetItemType())
    {
        ...
        case MenuItemType::SEPARATOR: return false;
...
void MenuItem::AdjustToBeInsideScreen()
{
    ...
    RectTransform *thisListRT =
        GetChildrenList()->GetGameObject()->GetRectTransform();
    ...
    GetChildrenList()
        ->GetGameObject()
        ->GetComponent<UIContentSizeFitter>()
...
void MenuItem::SetSelectedCallback(
    MenuItem::ItemSelectedCallback selectedCallback)
{
...
{
    return IsDropDownEnabled() && (GetItemType() == MenuItemType::ROOT ||
                                   IsForcedShow() || IsSelected());
}
