...
MenuItem *MenuBar::GetItem(int i) { return m_items[i]; }
...
void MenuBar::CreateGameObjectMiscMenuInto(
    MenuItem *rootItem, MenuItem **alignGameObjectWithViewItemOut,
...
void BangEditor::MenuBar::CreateAssetsMenuInto(BangEditor::MenuItem *rootItem) {
  ...
  MenuItem *createAnimatorLayerMask = rootItem->AddItem("Animator Layer Mask");
...
void MenuBar::OnBuild(MenuItem *) { GameBuilder::BuildGame(); }
...
void MenuBar::OnUndo(MenuItem *) { UndoRedoManager::Undo(); }

void MenuBar::OnRedo(MenuItem *) { UndoRedoManager::Redo(); }
...
void MenuBar::OnCreateBehaviour(MenuItem *) { CreateNewBehaviour(); }
...
template <class T> T *OnAddComponent() {
  T *comp = nullptr;
...
void MenuBar::OnAddAnimator(MenuItem *) { OnAddComponent<Animator>(); }

void MenuBar::OnAddAudioListener(MenuItem *) {
  OnAddComponent<AudioListener>();
}

void MenuBar::OnAddAudioSource(MenuItem *) { OnAddComponent<AudioSource>(); }
...
void MenuBar::OnAddExistingBehaviour(MenuItem *) {
  ...
  EditorDialog::GetAsset("Select an existing Behaviour...",
                         Extensions::GetSourceFileExtensions(), &behaviourPath,
                         &accepted);
...
void MenuBar::OnAddBoxCollider(MenuItem *) { OnAddComponent<BoxCollider>(); }
...
void MenuBar::OnAddPointLight(MenuItem *) { OnAddComponent<PointLight>(); }

void MenuBar::OnAddDirectionalLight(MenuItem *) {
  OnAddComponent<DirectionalLight>();
}

void MenuBar::OnAddLineRenderer(MenuItem *) { OnAddComponent<LineRenderer>(); }

void MenuBar::OnAddMeshRenderer(MenuItem *) { OnAddComponent<MeshRenderer>(); }
...
void MenuBar::OnAddTransform(MenuItem *) { OnAddComponent<Transform>(); }
...
void MenuBar::OnAddUIButton(MenuItem *) { OnAddComponent<UIButton>(); }
...
void MenuBar::OnAddUIMask(MenuItem *) { OnAddComponent<UIMask>(); }

void MenuBar::OnAddUIRectMask(MenuItem *) { OnAddComponent<UIRectMask>(); }

void MenuBar::OnAddUISlider(MenuItem *) { OnAddComponent<UISlider>(); }
...
void MenuBar::OnAddUICanvas(MenuItem *) { OnAddComponent<UICanvas>(); }

void MenuBar::OnAddUICheckBox(MenuItem *) { OnAddComponent<UICheckBox>(); }

void MenuBar::OnAddUIComboBox(MenuItem *) { OnAddComponent<UIComboBox>(); }

void MenuBar::OnAddUIFocusable(MenuItem *) { OnAddComponent<UIFocusable>(); }

void MenuBar::OnAddUIInputText(MenuItem *) { OnAddComponent<UIInputText>(); }

void MenuBar::OnAddUILabel(MenuItem *) { OnAddComponent<UILabel>(); }

void MenuBar::OnAddPostProcessEffect(MenuItem *) {
  OnAddComponent<PostProcessEffect>();
}

void MenuBar::OnAddRope(MenuItem *) { OnAddComponent<Rope>(); }

void MenuBar::OnAddCloth(MenuItem *) { OnAddComponent<Cloth>(); }

void MenuBar::OnAddSSAO(MenuItem *) { OnAddComponent<PostProcessEffectSSAO>(); }

void MenuBar::OnAddRigidBody(MenuItem *) { OnAddComponent<RigidBody>(); }
...
Path MenuBar::CreateNewBehaviour() {
  ...
  BehaviourCreator::CreateNewBehaviour(
      behaviourDir, behaviourName, &behaviourHeaderPath, &behaviourSourcePath);
