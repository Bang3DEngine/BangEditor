...
UITabContainer::UITabContainer()
{
    ...
    UIHorizontalLayout *headerBarHL =
        GetHeadersBar()->AddComponent<UIHorizontalLayout>();
    headerBarHL->SetChildrenVerticalStretch(Stretch::NONE);
    headerBarHL->SetChildrenVerticalAlignment(VerticalAlignment::BOT);

    // UIImageRenderer *barBg =
    // GetHeadersBar()->AddComponent<UIImageRenderer>();
    // barBg->SetTint(Color::White.WithValue(0.4f));

    UILayoutElement *headerBarLE =
        GetHeadersBar()->AddComponent<UILayoutElement>();
    ...
    /*
    GameObject *hiddenTabsFocusBlocker =
    GameObjectFactory::CreateUIGameObject();
    hiddenTabsFocusBlocker->AddComponent<UIFocusable>();
    UIImageRenderer *bg =
    hiddenTabsFocusBlocker->AddComponent<UIImageRenderer>();
...
void UITabContainer::AddTabByTabHeader(UITabHeader *tabHeader, uint index_)
{
...
void UITabContainer::RemoveTab(GameObject *tabbedChild, bool destroy)
{
...
void UITabContainer::RemoveTabByHeader(UITabHeader *tabHeader, bool destroy)
{
...
UITabHeader *UITabContainer::GetTabHeaderFromChild(
    GameObject *tabbedChild) const
{
