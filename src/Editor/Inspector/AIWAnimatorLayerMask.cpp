...
AIWAnimatorLayerMask::AIWAnimatorLayerMask()
{
}
...
void AIWAnimatorLayerMask::Init()
{
    AIWAsset<AnimatorLayerMask>::Init();

    SetName("AIWAnimatorLayerMask");
...
void AIWAnimatorLayerMask::UpdateInputsFromAsset()
{
    Array<AnimatorLayerMask::BoneEntry> layerBoneMaskEntries =
        GetAsset().Get()->GetBoneEntries();
...
Texture2D *AIWAnimatorLayerMask::GetIconTexture() const
{
    return EditorTextureFactory::GetAnimatorLayerMaskIcon();
}

void AIWAnimatorLayerMask::OnValueChangedAIWAsset(
    EventEmitter<IEventsValueChanged> *object)
{
    BANG_UNUSED(object);

    AnimatorLayerMask *layerMask = (GetAsset().Get());
...
AIWAnimatorLayerMask::GetBoneEntriesFromInputs() const
{
    Array<AnimatorLayerMask::BoneEntry> maskBoneEntries;
